...
WORKFLOW_EXECUTION_AUTOMATION = {
  ...
  "execution_slurm_remote_poll_max_rounds": 20,
...
WORKFLOW_DISCOVERY_AUTOMATION = {
  ...
  "batch_size": 5,
  # "tick_discovery_batch_limit": 4,
  # "concurrent_discovery_batch_limit": 2,
  "stale_after_hours": 24,
  # "claim_ttl_minutes": 180,
  # "discovery_max_attempts_external": 12,
  # "discovery_max_duration_minutes_external": 45,
  # "discovery_max_attempts_db": 10,
  # "discovery_max_duration_minutes_db": 15,
  # "discovery_initial_retry_seconds": 2.0,
  # "discovery_max_retry_interval_seconds": 120.0,
}
